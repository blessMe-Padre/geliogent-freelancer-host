<?php
/*
Template Name: шаблон страница - Информация
*/
get_header();
?>
<h1 class="visually-hidden">Гелиодент - Информация</h1>
...
<section class="faq">
    <div class="container">
        <h2 class="faq__title faq__title--info">Информация</h2>
        ...
        <a href="#" class="faq__load-more-btn">посмотреть всё</a>
    </div>
</section>
